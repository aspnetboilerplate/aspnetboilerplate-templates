    ...
    function (router) {
        ...
        return new function () {
            ...
            that.activate = function () {
                router.map([
                    { route: '', title: abp.localization.localize('HomePage', 'MyMvcProject'), moduleId: 'viewmodels/home', nav: true },
                    { route: 'about', title: abp.localization.localize('About', 'MyMvcProject'), moduleId: 'viewmodels/about', nav: true }
